<div class="flex flex-col h-screen w-64 shadow-lg bg-white">
    <!-- Brand -->
    <div class="bg-green-600 text-white p-4 text-2xl font-bold tracking-wide">
        Emoti App
    </div>
    ...
    <div class="flex-1 p-4 space-y-4">
        ...
        <div class="space-y-2">
            ...
            <a href="/admin/counselor-sessions" class="flex items-center gap-2 px-3 py-2 rounded-lg hover:bg-green-50 transition text-gray-800">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
